...
with conDB:
    ...
    cur.execute("CREATE TABLE Quotes(numb INTEGER PRIMARY KEY AUTOINCREMENT, quote TEXT NOT NULL UNIQUE,\
                addedby TEXT NOT NULL, timestamp TEXT NOT NULL, quoted TEXT NOT NULL);")
